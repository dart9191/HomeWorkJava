...
public class HomeWork3 {
    ...
    public static void turnHuman() {
        ...
        do {
            System.out.println("Введите координату клетки вашего хода: ");
    ...
    public static boolean winGame(char player) {
        ...
        if (field[0][3] == player && field[1][2] == player && field[2][1] == player && field[3][0] == player) return true;
        if (field[0][4] == player && field[1][3] == player && field[2][2] == player && field[3][1] == player) return true;
        if (field[1][3] == player && field[2][2] == player && field[3][1] == player && field[4][0] == player) return true;
        if (field[1][4] == player && field[2][3] == player && field[3][2] == player && field[4][1] == player) return true;
        return false;
    }
    ...
    public static boolean validCell(int cellX, int cellY) {
